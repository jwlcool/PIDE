...
from coevolve.common.dataset import train_data, test_data, kg_test
...
def main_loop():
    ...
    model = DeepCoevolve(train_data, test_data, num_users=cmd_args.num_users, num_items=cmd_args.num_items,
                         embed_size=cmd_args.embed_dim,
                         score_func=cmd_args.score_func, dt_type=cmd_args.dt_type, max_norm=cmd_args.max_norm).to(
        DEVICE)
