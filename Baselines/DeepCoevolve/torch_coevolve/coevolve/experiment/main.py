...
def main_loop():
    ...
    for epoch in range(cmd_args.num_epochs):
        ...
        mar, HR_5, HR_10, HR_20, mae, rmse,ndcg_5,ndcg_10,ndcg_20 = model(train_data.ordered_events[-1].t,
                                                   test_data.ordered_events[:1000],  # 前1000个数据
                                                   phase='test')
        print('MAR:', mar, 'HR@5:', HR_5, 'HR@10:', HR_10, 'HR@20:', HR_20,'NDCG@5:', ndcg_5,'NDCG@10:', ndcg_10,'NDCG@20:', ndcg_20)
